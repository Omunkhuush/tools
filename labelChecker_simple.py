...
colors = [(0, 0, 255), (255, 0, 0), (0, 255, 0),
          (0, 255, 255), (204, 0, 102)]
# colors = [(0, 0, 255), (255, 0, 0), (0, 255, 0),
#           (0, 255, 255), (204, 0, 102), (0, 153, 255),
#           (255, 153, 255), (255, 255, 0), (255, 255, 255)]
#numClasses = ['Bus', 'Bike', 'Van', 'Car', 'Sedan', 'Pedestrian', 'SUV', 'Taxi', 'Truck']
#numClasses = ['Bus', 'Bike', 'Car', 'Sedan', 'Pedestrian', 'SUV', 'Taxi', 'Truck']
